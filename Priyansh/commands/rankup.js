...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
  ...
  if (level > curLevel && level != 1) {
    ...
    var background = [
  "https://i.imgur.com/hpKi2uV.png",
      "https://i.imgur.com/mNz4Pvi.png",
      "https://i.imgur.com/mNz4Pvi.png",
  ];
  ...
  fs.writeFileSync(pathImg, Buffer.from(getbackground, "utf-8"));
    ...
    ctx.drawImage(baseAvt1, 55, 210, 280, 280);
...
module.exports.languages = {
  ...
  "en": {
    ...
    "levelup": "{name}, Ji Mere Hisab Se Aapki Shadi Something {level} Sal K Bad Hogi 😀😅",
  }
}
